...
def test_gcloudsdk_repofile_exists(host):
    assert host.file('/etc/apt/sources.list.d/google-cloud-sdk.list').exists or \
      host.file('/etc/yum.repos.d/google-cloud-sdk.repo').exists


def test_gcloudsdk_repofile_isfile(host):
    assert host.file('/etc/apt/sources.list.d/google-cloud-sdk.list').is_file or \
      host.file('/etc/yum.repos.d/google-cloud-sdk.repo').is_file
